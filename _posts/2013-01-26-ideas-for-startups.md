...
> ##内容提要：
> 1.   为什么大家觉得想点子难，大多数是因为觉得难而放弃，不愿自己尝试或者想走捷径。
> 2.   找一个最初的点子，把它当作一个引子问题，它或许会帮你一步步找到答案。
> 3.   你需要熟悉有前景的新科技和趣味相投的朋友组成小组一起讨论。
> 4.   开始涂鸦式的做些尝试，最简单的做法就是找到一个可以改进或者无法忍受并且可以解决的问题，搞定它。
> 5.   与财富相关的点子或许可以考虑：一是把复杂的需求简单化，一是把奢侈的需求品廉价化。
> 6.   你需要某种退场机制，比如被大企业收购。
> 7.   伍茲(Woz)路線，做自己乐意做的事，意外的产生点子。
> 
...
> ##批注
> [1]: 这个现象可能会解释很多目前归咎于各种被禁思想的差异。能用数学解释的事情千万不要用恶意来解释。
> [2]: 很多古典的抽象表现主义都会做这类的涂鸦：训练艺术家用相同的笔势去写生，不过却不要呈现任何东西。这解释了绘画(稍微)比随便乱画有趣的原因。
> [3]: Bill Yerazunis已经解决了这个问题，不过是走另一条路。他做出一个泛用的档案分类器，效果好到对垃圾信也有效。
